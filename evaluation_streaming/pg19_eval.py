...
def pg19_eval(model,tokenizer,output_dir,KVcache=None,device="cuda",args_num_eval_tokens=30000):
    ...
    num_eval_tokens=args_num_eval_tokens
...
if __name__ == "__main__":
    ...
    parser.add_argument("--num_eval_tokens", type=int, default=30000)
    ...
    print(f"---------KV_cache type: {KV_cache.type}---------")
    


    pg19_eval(model,tokenizer,args.output_dir,KV_cache,device)